...
export async function run() {
  ...
  if (!subcommand || subcommand === "--help" || !commands[subcommand]) {
    ...
    console.log("  npx -y cdp-browser <command> [args...]");
    console.log("  node bin/browser.js <command> [args...]");
    console.log("\nCommands:");
    console.log("  start [--headless] [--fresh] [--copy-profile [name]] [--browser <path-or-name>]  Start Chrome/Chromium with remote debugging");
